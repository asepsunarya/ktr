  ...
  <!-- Header Section -->
    <header class="relative z-50 w-full h-24">
        <div
            ...
            <nav id="nav"
                ...
                <a href="#features"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Alur Pelayanan</a>
                <a href="#pricing"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Harga</a>
                <a href="#pricing"
                    class="md:mr-3 lg:mr-8 font-bold duration-100 transition-color hover:text-indigo-600">Jangka Waktu</a>
                <a href="#testimonials"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">S&K</a>
                <div class="flex flex-col block w-full font-medium border-t border-gray-200 md:hidden">
                    <a href="/login" class="w-full py-2 font-bold text-center text-pink-500">Login</a>
                    <a href="/register"
                        class="relative inline-block w-full px-5 py-3 text-sm leading-none text-center text-white bg-indigo-700 fold-bold">Memulai</a>
                </div>
            </nav>
            ...
            <div
                ...
                <a href="/register"
                    class="relative z-40 inline-block w-auto h-full px-5 py-3 text-sm font-bold leading-none text-white transition-all transition duration-100 duration-300 bg-indigo-700 rounded shadow-md fold-bold lg:bg-white lg:text-indigo-700 sm:w-full lg:shadow-none hover:shadow-xl">Memulai</a>
    ...
    <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
        <div
            ...
            <div
                ...
                <h1 class="relative mb-4 text-3xl font-black leading-tight text-gray-900 sm:text-6xl xl:mb-8">Perencanaan Tata Ruang</h1>
                <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">Ayo mulai langkah perencanaan tata ruang Anda sekarang dan raih manfaat jangka panjang untuk masyarakat, lingkungan, dan ekonomi.</p>
                <a href="/register"
                ...
                <!-- <div class="flex-col hidden mt-12 sm:flex lg:mt-24">
                    <p class="mb-4 text-sm font-medium tracking-widest text-gray-500 uppercase">Terintegrasi Dengan</p>
                    <div class="flex">
    ...
    <div id="features" class="relative w-full px-8 py-10 border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
        <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
            <h2 class="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase">Alur Pelayanan</h2>
            <h3
            ...
            <div class="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">{{ setting.service_flow_title_1 }}</h4>
                        <p class="relative mt-2 text-base text-center text-gray-600">{{ setting.service_flow_description_1 }}</p>
                    </div>
                </div>
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">{{ setting.service_flow_title_2 }}</h4>
                        <p class="relative mt-2 text-base text-center text-gray-600">{{ setting.service_flow_description_2 }}</p>
                    </div>
                </div>
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold">{{ setting.service_flow_title_3 }}</h4>
                        <p class="relative mt-2 text-base text-center text-gray-600">{{ setting.service_flow_description_3 }}</p>
                    </div>
                </div>
    ...
    <div class="relative px-8 py-10 bg-white border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
        ...
        <div id="pricing" class="container flex flex-col items-center h-full max-w-6xl mx-auto">
            <h2 class="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase">Harga dan Biaya</h2>
            <h3
            ...
            <div class="max-w-full mx-auto md:max-w-6xl sm:px-8">
                ...
                <div class="relative flex flex-col items-center block sm:flex-row">
                    ...
                    <!-- Pro Pricing -->
                    <div
                        class="relative z-10 w-full max-w-md my-8 bg-white rounded-lg shadow-lg">
                        <div
                        ...
                        <div class="block max-w-sm px-8 mx-auto mt-5 text-sm text-left text-black sm:text-md lg:px-6">
                            <h3 class="p-3 pb-1 text-lg font-light tracking-wide text-center uppercase">Maksimal waktu pengerjaan</h3>
                            <h4
                                class="flex items-center justify-center pb-6 text-5xl font-bold text-center text-gray-900">
                                {{ setting.time_period }}
                            </h4>
                            <p class="text-sm text-gray-600">Dengan perubahan status sebagai berikut:</p>
                        </div>
                        <div class="flex justify-start pl-12 mt-8 sm:justify-start">
                            <ul>
                                <li class="flex items-center">
                                    ...
                                    <span class="ml-3 text-lg text-gray-700">Sedang dalam proses pembuatan KTR
                                    </span>
                                </li>
                                <li class="flex items-center">
                                    <div class="p-2 text-green-500 rounded-full fill-current ">
                                    ...
                                    <span class="ml-3 text-lg text-gray-700">KTR sedang dalam proses approval Kepala Bidang Tata
                                        Ruang</span>
                                </li>
                                <li class="flex items-center">
                                    <div class="p-2 text-green-500 rounded-full fill-current ">
                                    ...
                                    <span class="ml-3 text-lg text-gray-700">KTR sedang dalam proses pendaftaran
                                        pengadministrasian</span>
                                </li>
                                <li class="flex items-center">
                                    <div class="p-2 text-green-500 rounded-full fill-current ">
                                        <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <span class="ml-3 text-lg text-gray-700">KTR sudah dapat diambil</span>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="flex-col items-center ">
                <div class="flex flex-col items-center justify-center w-full h-full max-w-2xl pr-8 mx-auto text-center">
                    ...
                    <h2
                        ...
                        Syarat & Ketentuan</h2>
                    <p class="my-6 text-xl font-medium text-gray-500">Mohon penuhi syarat & ketentuan sebelum melakukan permohonan</p>
    ...
    <footer class="px-4 pt-12 pb-8 text-white bg-white border-t border-gray-200">
            ...
            <div class="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
                ...
                <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                    <li class="inline-block px-3 py-2 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                        WhatsApp</li>
                    <li><a :href="`https://wa.me/${setting.phone}`" target="_blank"
                            class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">{{ setting.phone }}</a>
                    </li>
                ...
                <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                    ...
                    <li><a :href="setting.website" target="_blank"
                            class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">
                            {{ setting.website }}</a></li>
                    
                </ul>
                <div class="flex flex-col w-full text-gray-700">
                    <div class="inline-block px-3 py-2 mt-5 font-bold text-gray-800 uppercase md:mt-0">Email</div>
        ...
        <div class="pt-4 pt-6 mt-10 text-center text-gray-500 border-t border-gray-100">© 2025 KTR. All rights
            reserved.</div>
    </footer>
...
const getSettings = async () => {
  try {
    ...
    if (response.status == 200) {
        ...
        for (let data of settings.value) {
