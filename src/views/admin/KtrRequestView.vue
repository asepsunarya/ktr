...
const fetchStatistics = async () => {
  const { data } = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/ktr-requests/admin/stats`)
  statistics.value = data
}

const fetchRequests = async () => {
  const { data } = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/ktr-requests`)
